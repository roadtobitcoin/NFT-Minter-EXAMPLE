...
import i1 from "./assets/images/1.PNG.png";
  ...
  const claimNFTs = (_to) => {
    ...
    blockchain.smartContract.methods
      ...
      .send({
        ...
        value: blockchain.web3.utils.toWei((0.03).toString(), "ether"),
      })
      .once("error", (err) => {
        console.log(err);
      ...
      .then((receipt) => {
        setFeedback(
          "WOW, you now own a cyrpto Panda token. go visit Opensea.io to view it."
        );
        setClaimingNft(false);
            ...
            {Number(data.currentSupply) === 20 ? (
              <>
                ...
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can still find Panda NFT token on{" "}
                  <a
                    target={"_blank"}
              ...
              <>
                ...
                blockchain.smartContract === null ? (
                  <s.Container ai={"center"} jc={"center"}>
                    <s.TextDescription style={{ textAlign: "center" }}>
                      Connect to the Rinkeby Testnet network
                    </s.TextDescription>
                    <s.SpacerSmall />
                    <StyledButton
                      onClick={(e) => {
